...
# Summary of changes: Added share/chat_ui and share/agent subdirectories to build
...
def options(opt):
    ...
    opt.add_option('--program-name', type='string', action='store', default='LabDAWg', dest='program_name',
...
def configure(conf):
    ...
    conf.env['PROGRAM_NAME'] = Options.options.program_name or 'LabDAWg'
